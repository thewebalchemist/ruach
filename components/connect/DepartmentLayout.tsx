        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-b border-white/[0.06]">
            <Link href="/department" className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-bold text-white truncate">{department.name}</p>
          ...
          <div className="p-4 border-t border-white/[0.06]">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-white truncate">Dept. Leader</p>
                <p className="text-xs text-gray-500">HOD</p>
              </div>
            </div>
            <Link href="/department" className="flex items-center gap-2 px-3 py-2 text-sm text-white/50 hover:bg-white/5 dark:hover:bg-[#252525] rounded-lg">
