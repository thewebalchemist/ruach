        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-b border-gray-200 dark:border-[#2D2D2D]">
            <Link href="/crosspoint" className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-bold text-gray-900 dark:text-white truncate">{crosspoint.name}</p>
          ...
          <div className="p-4 border-t border-gray-200 dark:border-[#2D2D2D]">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-gray-900 dark:text-white truncate">CP Leader</p>
                <p className="text-xs text-gray-500">Leader</p>
              </div>
            </div>
            <Link href="/crosspoint" className="flex items-center gap-2 px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-[#252525] rounded-lg">
