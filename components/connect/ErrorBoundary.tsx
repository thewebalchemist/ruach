...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#0A0C10] p-6">
          <div className="max-w-md w-full">
            <div className="bg-white dark:bg-[#12151C] rounded-2xl border border-gray-200 dark:border-white/[0.06] p-8 text-center shadow-lg">
              ...
              <div className="flex gap-3 justify-center">
                <button
                  ...
                  className="px-4 py-2 bg-gray-100 dark:bg-[#2A2A2A] text-gray-700 dark:text-white/70 rounded-xl text-sm font-semibold hover:bg-gray-200 dark:hover:bg-[#333] transition-colors"
                >
                  Try again
                </button>
                <button
              ...
              {process.env.NODE_ENV === 'development' && this.state.error && (
                <details className="mt-6 text-left">
                  ...
                  <pre className="mt-2 text-xs bg-gray-50 dark:bg-white/[0.04] p-3 rounded-xl overflow-auto text-red-600 dark:text-red-400 border border-gray-200 dark:border-white/[0.06]">
