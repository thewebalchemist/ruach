  ...
  return (
    <DepartmentLayout department={department} title="Messages">
      <div className="mb-6">
        ...
        <p className="text-gray-500">Direct messages and broadcasts to department members</p>
      </div>

      <div className="bg-white dark:bg-[#1A1A1A] rounded-xl border border-gray-200 dark:border-[#2D2D2D] p-12 text-center">
        <MessageSquare className="w-12 h-12 text-gray-300 mx-auto mb-4" />
        <p className="text-gray-500 font-medium">In-app messaging isn't available yet</p>
        <p className="text-sm text-gray-400 mt-1">Use the Notice Board to reach all department members in the meantime.</p>
      </div>
    </DepartmentLayout>
  );
}
