      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              <p className="text-[#BF0A30] text-xs font-bold uppercase tracking-widest mb-4" style={heading}>A Word from The Team Leader</p>
              ...
              <Link href="/new-here" className="inline-flex items-center gap-2 bg-[#BF0A30] text-white font-bold text-xs uppercase tracking-wider px-6 py-3.5 rounded-lg hover:bg-[#9A0826] transition-colors" style={heading}>
      ...
      <section className="bg-[#F5F0E8] py-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {PROGRAMS.map((p) => (
              <div key={p.name} className="bg-[#111827] rounded-2xl p-8">
