...
export default function PrayerRequestsPage() {
  ...
  const getCategoryColor = (cat: string) => {
    const colors: Record<string, string> = {
      ...
      other: 'bg-gray-100 dark:bg-white/5 text-gray-800 dark:text-gray-300',
    };
  ...
  return (
    <AdminLayout title="Prayer Requests">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        ...
        <button onClick={() => setFilter('praying')} className={`bg-white dark:bg-[#12151C] rounded-xl border-l-4 border-l-blue-500 border p-4 text-left transition-colors ${filter === 'praying' ? 'border-[#BF0A30] ring-2 ring-[#BF0A30]/20' : 'border-gray-200 dark:border-white/[0.06]'}`}>
        ...
        <button onClick={() => setFilter('answered')} className={`bg-white dark:bg-[#12151C] rounded-xl border-l-4 border-l-green-500 border p-4 text-left transition-colors ${filter === 'answered' ? 'border-[#BF0A30] ring-2 ring-[#BF0A30]/20' : 'border-gray-200 dark:border-white/[0.06]'}`}>
      ...
      <div className="space-y-4">
        {filtered.map((pr) => (
          <div key={pr.id} className="bg-white dark:bg-[#12151C] rounded-xl border border-gray-200 dark:border-white/[0.06] p-5">
            ...
            <p className="text-gray-700 dark:text-white/70 mb-4">{pr.request}</p>
