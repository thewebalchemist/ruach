    ...
    <AdminLayout title="Broadcast">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="bg-white dark:bg-[#12151C] rounded-xl border border-gray-200 dark:border-white/[0.06] p-5">
            ...
            <div className="space-y-2">
              {AUDIENCE_SEGMENTS.map(seg => (
                <div key={seg.id}>
                  <label className="flex items-center gap-3 p-3 rounded-xl cursor-pointer hover:bg-gray-50 dark:hover:bg-white/[0.06] transition-colors">
                    <input
                      type="checkbox"
                    ...
                    <div className="flex-1">
                      <span className="text-sm font-semibold text-gray-800 dark:text-white">{seg.label}</span>
                    </div>
          ...
          {/* Message Composer */}
          <div className="bg-white dark:bg-[#12151C] rounded-xl border border-gray-200 dark:border-white/[0.06] p-5 space-y-4">
            <h2 className="font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center gap-2 p-4 rounded-xl border transition-all ${
                      active
                        ...
                        : 'border-gray-200 dark:border-white/[0.06] bg-gray-50 dark:bg-white/[0.04] hover:border-gray-300'
                    }`}
                  >
                    ...
                    <span className={`text-xs font-bold ${active ? 'text-[#BF0A30]' : 'text-gray-500 dark:text-white/50'}`}>{cfg.label}</span>
                ...
                <button
                  ...
                  className={`flex-1 py-3 rounded-xl text-sm font-bold border transition-all capitalize ${
                    scheduleMode === mode
                      ...
                      : 'bg-gray-50 dark:bg-white/[0.04] text-gray-500 dark:text-white/50 border-gray-200 dark:border-white/[0.06] hover:border-gray-300'
                  }`}
                >
          ...
          <div className="bg-white dark:bg-[#12151C] rounded-xl border border-gray-200 dark:border-white/[0.06] p-5">
            ...
            {channels.has('in-app') && (
              <div className="mb-4">
                ...
                <div className="bg-gray-50 dark:bg-white/[0.04] rounded-xl p-4 border border-gray-200 dark:border-[#3D3D3D]">
      ...
      {showConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fade-in">
          <div className="bg-white dark:bg-[#12151C] rounded-2xl border border-gray-200 dark:border-white/[0.06] p-6 w-full max-w-sm shadow-2xl animate-fade-in-scale">
