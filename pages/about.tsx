    ...
    >
      ...
      <section className="relative min-h-[70vh] flex items-end bg-[#0A0C10] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 pb-20 pt-32 w-full">
          <Reveal variant="fade" as="p" className="text-[#BF0A30] text-[10px] font-bold uppercase tracking-widest mb-4" style={H}>Who We Are</Reveal>
          <Reveal variant="none" as="h1" className="text-[38px] sm:text-5xl md:text-[58px] text-white leading-tight tracking-tight mb-5" style={H}>
            <RiseLine index={0}>You&apos;re</RiseLine>
            <RiseLine index={1} style={serif}>Family.</RiseLine>
          </Reveal>
          <Reveal variant="blur" delay={450} as="p" className="text-[#8B95A8] text-lg max-w-md leading-relaxed">
      ...
      <section className="bg-[#0A0C10] py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <Reveal variant="fade" as="p" className="text-[#BF0A30] text-[10px] font-bold uppercase tracking-widest mb-4" style={H}>Our Mission</Reveal>
              <Reveal variant="none" as="h2" className="text-4xl md:text-5xl text-white leading-tight mb-6" style={H}>
                <RiseLine index={0}>To Raise</RiseLine>
                <RiseLine index={1} style={serif}>Kingdom Champions</RiseLine>
              </Reveal>
              <Reveal variant="blur" delay={200} as="p" className="text-[#8B95A8] text-base leading-relaxed mb-5">
              ...
              <Reveal variant="blur" delay={320} as="p" className="text-[#8B95A8] text-sm leading-relaxed mb-8">
            ...
            <div className="space-y-4">
              {VALUES.map((v, vi) => (
                <Reveal key={v.title} variant="right" delay={vi * 110} className="bg-[#12151C] border border-white/5 rounded-2xl p-6 flex gap-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          <Reveal variant="none" className="text-center mb-14">
            ...
            <h2 className="text-4xl md:text-5xl text-[#111827] leading-tight" style={H}>
              <RiseLine index={0}>What We</RiseLine>
              <RiseLine index={1} style={serif}>Believe</RiseLine>
            </h2>
          </Reveal>

          <div className="grid md:grid-cols-3 gap-5">
            {BELIEFS.map((b, bi) => (
              <Reveal key={b.title} variant="up" delay={bi * 120} className="bg-[#000000] rounded-2xl p-8">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-12">
          <Reveal variant="none">
            ...
            <h2 className="text-3xl md:text-4xl text-white mb-10" style={H}>
              <RiseLine index={0}>Our Core Beliefs</RiseLine>
            </h2>
          </Reveal>
          <div className="space-y-3">
            {BELIEFS.map((b, bi) => (
              <Reveal key={b.title} variant="up" delay={bi * 70}>
                <BeliefCard title={b.title} text={b.text} ref={b.ref} />
              </Reveal>
            ))}
          </div>
        </div>
      ...
      <section className="bg-[#F5F0E8] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          <Reveal variant="up" className="bg-[#000000] rounded-3xl overflow-hidden grid md:grid-cols-2">
      ...
      <section className="bg-[#BF0A30] py-16 text-center">
        <div className="max-w-2xl mx-auto px-8">
          <Reveal variant="fade" as="p" className="text-red-200 text-[10px] font-bold uppercase tracking-widest mb-4" style={H}>Every Sunday · 3 Services</Reveal>
          <Reveal variant="none" as="h2" className="text-4xl md:text-5xl text-white mb-5 leading-tight" style={H}>
            <RiseLine index={0}>Come as</RiseLine>
            <RiseLine index={1} style={serif}>You Are.</RiseLine>
          </Reveal>
          <Reveal variant="blur" delay={250} as="p" className="text-red-100 text-sm leading-relaxed mb-8 max-w-sm mx-auto">
            We welcome you. Whether you prefer to dress up or dress down — your seat is ready.
          </Reveal>
          <Reveal variant="up" delay={400} className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              href="/new-here"
