  ...
  return (
    <ConnectLayout title="Graduates">
      ...
      <div className="flex items-center justify-between mb-5">
        ...
        <button className="flex items-center gap-2 px-4 py-2.5 border border-gray-200 dark:border-white/[0.06] rounded-xl text-sm font-medium text-gray-700 dark:text-gray-300 hover:border-[#BF0A30] hover:text-[#BF0A30] transition-colors">
      ...
      <div className="grid grid-cols-3 gap-3 mb-5">
        {[
          { icon: Users,       val: graduates.length,     label: 'Total Graduates',    color: 'text-gray-900 dark:text-white', bg: 'bg-gray-100 dark:bg-[#1A1A1A]' },
