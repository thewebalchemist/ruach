    ...
    <ConnectLayout title="Exams">
      ...
      <div className="flex gap-3 mb-5">
        <select
          ...
          className="px-4 py-2.5 text-sm border border-gray-200 dark:border-white/[0.06] rounded-xl bg-white dark:bg-[#12151C] text-gray-900 dark:text-white focus:outline-none focus:border-[#BF0A30]"
        >
      ...
      <div className="space-y-3">
        {filtered.length === 0 ? (
          <div className="bg-white dark:bg-[#12151C] rounded-2xl border border-gray-200/70 dark:border-white/[0.06]/70 p-16 text-center shadow-sm">
          ...
          return (
            <div key={exam.id} className="bg-white dark:bg-[#12151C] rounded-2xl border border-gray-200/70 dark:border-white/[0.06]/70 p-5 shadow-sm">
              <div className="flex items-start justify-between gap-4">
                ...
                <Link href={`/connect/exams/${exam.id}`} className="flex-shrink-0 flex items-center gap-1.5 px-3 py-1.5 border border-gray-200 dark:border-white/[0.06] rounded-xl text-xs font-medium text-gray-600 dark:text-white/50 hover:border-[#BF0A30] hover:text-[#BF0A30] transition-colors">
