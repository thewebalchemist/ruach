    ...
    <ConnectLayout title={exam.title}>
      ...
      <div className="bg-white dark:bg-[#141414] rounded-2xl border border-gray-200/70 dark:border-white/[0.05] p-5 mb-5 shadow-sm">
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            <Link href={`/connect/exams/new?edit=${exam.id}`} className="flex items-center gap-1.5 px-3 py-2 border border-gray-200 dark:border-white/[0.06] rounded-xl text-sm font-medium text-gray-600 dark:text-white/50 hover:border-[#BF0A30] hover:text-[#BF0A30] transition-colors">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
        {[
          ...
          <div key={label} className="bg-white dark:bg-[#12151C] rounded-2xl border border-gray-200/70 dark:border-white/[0.06]/70 p-4 shadow-sm text-center">
                ...
                {questions.map((q, i) => (
                  <div key={q.id} className="px-5 py-3.5">
                    <div className="flex items-start gap-3">
                      <span className="w-5 h-5 rounded-lg bg-gray-100 dark:bg-white/5 text-gray-500 dark:text-white/50 text-[10px] font-bold flex items-center justify-center flex-shrink-0 mt-0.5">
                        {i + 1}
                      </span>
            ...
            <div className="bg-white dark:bg-[#12151C] rounded-2xl border border-gray-200/70 dark:border-white/[0.06]/70 p-5 shadow-sm">
              ...
              {[
                ...
                <div key={label} className="flex items-center gap-3 mb-2.5 last:mb-0">
                  ...
                  <span className="text-xs font-medium text-gray-500 dark:text-white/50 w-4 text-right">{count}</span>
                </div>
              ))}
            </div>
          )}
