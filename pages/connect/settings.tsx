    ...
    <ConnectLayout title="Settings">
      ...
      <div className="grid lg:grid-cols-4 gap-5">
        ...
        <div className="lg:col-span-3">
          ...
          {section === 'profile' && (
            <div className="bg-white dark:bg-[#12151C] rounded-2xl border border-gray-200/70 dark:border-white/[0.06]/70 p-6 shadow-sm">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-medium text-gray-600 dark:text-white/50 mb-1.5">First Name</label>
                  <input value={firstName} onChange={e => setFirstName(e.target.value)} className="w-full px-4 py-2.5 border border-gray-200 dark:border-white/[0.06] rounded-xl bg-gray-50 dark:bg-[#0A0C10] text-sm text-gray-900 dark:text-white focus:outline-none focus:border-[#BF0A30]" />
                </div>
                <div>
                  <label className="block text-xs font-medium text-gray-600 dark:text-white/50 mb-1.5">Last Name</label>
                  <input value={lastName} onChange={e => setLastName(e.target.value)} className="w-full px-4 py-2.5 border border-gray-200 dark:border-white/[0.06] rounded-xl bg-gray-50 dark:bg-[#0A0C10] text-sm text-gray-900 dark:text-white focus:outline-none focus:border-[#BF0A30]" />
                </div>
                <div>
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-600 dark:text-white/50 mb-1.5">Phone</label>
                  <input type="tel" value={phone} onChange={e => setPhone(e.target.value)} className="w-full px-4 py-2.5 border border-gray-200 dark:border-white/[0.06] rounded-xl bg-gray-50 dark:bg-[#0A0C10] text-sm text-gray-900 dark:text-white focus:outline-none focus:border-[#BF0A30]" />
                </div>
              </div>
            </div>
          )}
