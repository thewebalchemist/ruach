      ...
      <ConnectLayout title="Import Attendance">
        <div className="max-w-md mx-auto text-center py-20">
          ...
          <div className="flex gap-3">
            <Link href="/connect/dashboard" className="flex-1 py-3 border border-gray-200 dark:border-white/[0.06] rounded-xl text-sm font-medium text-gray-700 dark:text-white/70 hover:bg-gray-50">
              Dashboard
            </Link>
            <button
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white dark:bg-[#12151C] rounded-2xl border border-gray-200/70 dark:border-white/[0.06]/70 p-5 shadow-sm">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-xs font-medium text-gray-600 dark:text-white/50 mb-1.5">Session</label>
                <select
          ...
          {parsedData.length > 0 && (
            <div className="bg-white dark:bg-[#12151C] rounded-2xl border border-gray-200/70 dark:border-white/[0.06]/70 p-5 shadow-sm">
              ...
              <div className="grid grid-cols-3 gap-3 mb-5">
                {[
                  { label: 'Total',     val: parsedData.length, color: 'text-gray-900 dark:text-white',   bg: 'bg-gray-50 dark:bg-white/5' },
              ...
              {matchedCount > 0 && (
                <div className="mb-4">
                  <p className="text-xs font-medium text-gray-600 dark:text-white/50 mb-2 flex items-center gap-1.5">
                    <CheckCircle className="w-3.5 h-3.5 text-green-500" /> Matched ({matchedCount})
                  </p>
                  <div className="max-h-36 overflow-y-auto rounded-xl border border-gray-100 dark:border-white/[0.04] divide-y divide-gray-50 dark:divide-white/[0.04]">
