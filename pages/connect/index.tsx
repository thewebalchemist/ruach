          ...
          {step === 'role' && (
            <div className="animate-fade-in">
                ...
                {(['student', 'teacher'] as Tab[]).map(t => (
                  <button key={t} onClick={() => setTab(t)}
                    className={`flex-1 py-2.5 rounded-xl text-sm font-semibold transition-all capitalize ${
                      tab === t
                        ? 'bg-[#2D2D2D] text-[#BF0A30] shadow-sm'
              ...
              <div className="bg-[#BF0A30]/12 border border-[#BF0A30]/20 rounded-xl p-4 mb-6">
                {tab === 'student' ? (
                  <>
                    <p className="text-sm font-semibold text-white mb-1">Student access</p>
                  ...
                  <>
                    <p className="text-sm font-semibold text-white mb-1">Teacher access</p>
                    <p className="text-xs text-gray-400">
