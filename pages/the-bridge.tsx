...
const ACTIVITIES = [
  {
    ...
    desc: 'Dynamic, Spirit-filled Sunday services with relevant teaching, vibrant worship, and a community that truly does life together.',
  },
  {
    title: 'Small Groups',
    desc: 'Intimate groups where young people connect deeper, study the Word, and build genuine friendships that last beyond Sunday.',
  },
  {
    title: 'Leadership Training',
    desc: 'We invest in the next generation of Kingdom leaders — equipping youth with the character, skills, and vision to lead well.',
  },
];

const PHOTOS = [
  { img: '/communities/the-bridge.jpg',  name: 'The Bridge',     subtitle: 'Youth Church' },
  { img: '/communities/the-bridge1.jpg', name: 'Community',      subtitle: 'Life Together' },
  { img: '/communities/the-bridge2.jpg', name: 'Rising Up',      subtitle: 'A Generation' },
];

export default function TheBridgePage() {
  return (
    <Layout
      title="The Bridge — Youth Church"
      description="The Bridge is Ruach Tabernacle's dynamic youth church — a community where young people encounter God, build purpose, and live boldly for the Kingdom."
    >
      ...
      <section className="relative min-h-[70vh] flex items-end bg-[#0A0C10] overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="/church-photos/aug-2025-c.jpg"
            alt="The Bridge Youth Church"
            className="absolute inset-0 w-full h-full object-cover opacity-45"
            onError={(e) => { (e.target as HTMLImageElement).src = '/communities/the-bridge.jpg'; }}
          />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 pb-20 pt-36 w-full">
          ...
          <Reveal variant="none" as="h1" className="text-[38px] sm:text-5xl md:text-[58px] text-white tracking-tight leading-tight mb-4" style={H}>
            <RiseLine index={0}>The Bridge</RiseLine>
          </Reveal>
            ...
            >
              {Array.from({ length: 6 }, (_, i) => (
                <span
                  ...
                  style={H}
                >
                  <span className="text-[#BF0A30]" style={serif}>Rise</span>
                  <span className="text-white/20 text-lg">·</span>
                  <span className="text-white/80">Purpose</span>
                  <span className="text-white/20 text-lg">·</span>
                  <span className="text-[#BF0A30]" style={serif}>Kingdom</span>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <Reveal variant="none" as="h2" className="text-4xl md:text-5xl text-[#111827] mb-6 leading-tight" style={H}>
                <RiseLine index={0}>A generation</RiseLine>
                <RiseLine index={1} style={serif}>rising up.</RiseLine>
              </Reveal>
              <Reveal variant="blur" delay={200} as="p" className="text-[#374151] leading-relaxed mb-4">
                The Bridge is Ruach Tabernacle&apos;s youth church — a vibrant, Spirit-filled community for young people who want to know God deeply, find their purpose, and make a real impact in the world around them.
              </Reveal>
              <Reveal variant="blur" delay={300} as="p" className="text-[#374151] leading-relaxed mb-8">
                We meet every Sunday alongside the main services, with dynamic worship, relevant teaching, and a community that does life together beyond the walls of Sunday. If you&apos;re a young person looking for more than just church — this is your place.
              </Reveal>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          <Reveal variant="none" className="mb-12">
            ...
            <h2 className="text-4xl md:text-5xl text-white leading-tight" style={H}>
              <RiseLine index={0}>Life at The Bridge</RiseLine>
            </h2>
          </Reveal>
