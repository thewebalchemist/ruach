  ...
  return (
    <DiscipleshipLayout title="Dashboard">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className={`bg-white dark:bg-[#12151C] rounded-xl border p-4 ${atRiskCount > 0 ? 'border-amber-300 dark:border-amber-800' : 'border-gray-200 dark:border-white/[0.06]'}`}>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
        {[
          ...
          <Link key={href} href={href}
            className="flex flex-col items-center gap-2 p-4 bg-white dark:bg-[#12151C] rounded-xl border border-gray-200 dark:border-white/[0.06] hover:border-[#BF0A30] transition-colors text-center">
            ...
            <div className="divide-y divide-gray-100 dark:divide-white/[0.06]">
              {levelGroups.map(({ level, label, activeCohorts: ac, enrolled }) => (
                <Link key={level} href={`/discipleship/cohorts?level=${level}`}
                  className="flex items-center gap-4 p-4 hover:bg-gray-50 dark:hover:bg-white/[0.06] transition-colors">
