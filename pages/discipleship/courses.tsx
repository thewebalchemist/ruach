    ...
    <DiscipleshipLayout title="Courses">
      ...
      <div className="space-y-6">
        {mockDiscipleshipCourses.map((course, idx) => {
          ...
          return (
            <div key={course.id} className="bg-[#12151C] rounded-2xl border border-white/[0.06] overflow-hidden">
              {/* Card Header */}
              ...
              {/* Stats Row */}
              <div className="grid grid-cols-2 sm:grid-cols-4 divide-x divide-y sm:divide-y-0 divide-white/[0.06] border-b border-white/[0.04]">
                <div className="p-4">
                  <div className="flex items-center gap-2 text-gray-500 text-xs mb-1">
                    <Clock className="w-3.5 h-3.5" />Duration
                  </div>
                  <p className="font-bold text-white">{course.durationWeeks} weeks</p>
                </div>
                <div className="p-4">
                  <div className="flex items-center gap-2 text-gray-500 text-xs mb-1">
                    <BookOpen className="w-3.5 h-3.5" />Sessions
                  </div>
                  <p className="font-bold text-white">{course.totalSessions}</p>
                </div>
                <div className="p-4">
                  <div className="flex items-center gap-2 text-gray-500 text-xs mb-1">
                ...
                <div className="p-4">
                  ...
                  <p className="font-bold text-white">{cohorts.length}</p>
                </div>
              </div>
