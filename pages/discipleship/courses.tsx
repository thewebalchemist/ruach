        ...
        {courses.map((course, idx) => {
          ...
          return (
            <div key={course.id} className="bg-white dark:bg-[#1A1A1A] rounded-2xl border border-gray-200 dark:border-[#2D2D2D] overflow-hidden">
              ...
              <div className="p-5">
                <h3 className="text-sm font-semibold text-gray-700 dark:text-white/70 mb-3">Topics Covered</h3>
                <div className="grid sm:grid-cols-2 gap-1.5">
                  {topics.map((topic, i) => (
                    <div key={i} className="flex items-center gap-2 text-sm text-gray-600 dark:text-white/50">
                      <span className="w-5 h-5 rounded-full bg-gray-100 dark:bg-white/5 flex items-center justify-center text-xs font-medium text-gray-500 flex-shrink-0">
                        {i + 1}
                      </span>
                      {topic}
                    </div>
                ...
                <div className="flex gap-3 mt-5">
                  <Link
                    ...
                    className="flex items-center gap-2 px-4 py-2 text-sm font-medium border border-gray-200 dark:border-white/10 dark:border-[#2D2D2D] rounded-lg text-gray-700 dark:text-white/70 hover:bg-gray-50 dark:hover:bg-white/[0.06]"
                  >
