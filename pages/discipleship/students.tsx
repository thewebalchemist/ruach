  ...
  return (
    <DiscipleshipLayout title="Students">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white dark:bg-[#12151C] rounded-xl border border-amber-200 dark:border-amber-800 p-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-200 dark:border-white/10 dark:border-[#2D2D2D] rounded-lg bg-transparent text-gray-900 dark:text-white"
              value={search}
              onChange={e => setSearch(e.target.value)}
            />
          </div>
          <select
            className="px-4 py-2.5 text-sm border border-gray-200 dark:border-white/10 dark:border-[#2D2D2D] rounded-lg bg-transparent text-gray-900 dark:text-white"
            value={filterLevel}
          ...
          <button
            ...
            className={`px-4 py-2.5 text-sm font-medium rounded-lg border transition-colors flex items-center gap-2 ${
              filterAtRisk
                ...
                : 'border-gray-200 dark:border-white/10 dark:border-[#2D2D2D] text-gray-700 dark:text-white/70 hover:bg-gray-50 dark:hover:bg-white/[0.06]'
            }`}
          >
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-white/[0.06]">
              {filtered.map(student => {
                ...
                return (
                  <tr key={student.id} className={`hover:bg-gray-50 dark:hover:bg-white/[0.06] ${isAtRisk ? 'border-l-2 border-amber-400' : ''}`}>
