  ...
  return (
    <DiscipleshipLayout title="Schedule">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white dark:bg-[#12151C] rounded-xl border border-purple-200 dark:border-purple-800 p-4">
      ...
      <div className="bg-white dark:bg-[#1A1A1A] rounded-xl border border-gray-200 dark:border-[#2D2D2D] p-4 mb-6">
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex-1">
            ...
            <select
              className="w-full px-4 py-2.5 text-sm border border-gray-200 dark:border-white/10 dark:border-[#2D2D2D] rounded-lg bg-transparent text-gray-900 dark:text-white"
              value={filterCohort}
