      ...
      <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-[#12151C] rounded-xl border border-gray-200 dark:border-white/[0.06] p-5">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white/70 mb-1">Program Name</label>
              <input
                type="text"
                className="w-full px-4 py-2.5 text-sm border border-gray-200 dark:border-white/10 dark:border-[#2D2D2D] rounded-lg bg-transparent text-gray-900 dark:text-white focus:outline-none focus:border-[#BF0A30]"
            ...
            <div>
              ...
              <textarea
                rows={3}
                className="w-full px-4 py-2.5 text-sm border border-gray-200 dark:border-white/10 dark:border-[#2D2D2D] rounded-lg bg-transparent text-gray-900 dark:text-white focus:outline-none focus:border-[#BF0A30] resize-none"
                value={settings.programDescription}
                onChange={e => setSettings(s => ({ ...s, programDescription: e.target.value }))}
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white/70 mb-1">Default Max Capacity per Cohort</label>
              <input
                type="number"
                min={5}
                max={200}
                className="w-full sm:w-48 px-4 py-2.5 text-sm border border-gray-200 dark:border-white/10 dark:border-[#2D2D2D] rounded-lg bg-transparent text-gray-900 dark:text-white focus:outline-none focus:border-[#BF0A30]"
        ...
        <div className="bg-white dark:bg-[#12151C] rounded-xl border border-gray-200 dark:border-white/[0.06] p-5">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white/70 mb-1">Academic Year Start</label>
              <input
                type="date"
                className="w-full px-4 py-2.5 text-sm border border-gray-200 dark:border-white/10 dark:border-[#2D2D2D] rounded-lg bg-transparent text-gray-900 dark:text-white focus:outline-none focus:border-[#BF0A30]"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-white/70 mb-1">Academic Year End</label>
              <input
                type="date"
                className="w-full px-4 py-2.5 text-sm border border-gray-200 dark:border-white/10 dark:border-[#2D2D2D] rounded-lg bg-transparent text-gray-900 dark:text-white focus:outline-none focus:border-[#BF0A30]"
        ...
        <div className="bg-white dark:bg-[#12151C] rounded-xl border border-gray-200 dark:border-white/[0.06] p-5">
          ...
          <div className="space-y-4">
            {settings.levelRequirements.map(req => (
              <div key={req.level} className="p-4 bg-gray-50 dark:bg-white/[0.04] rounded-xl">
        ...
        <div className="bg-white dark:bg-[#12151C] rounded-xl border border-gray-200 dark:border-white/[0.06] p-5">
          ...
          <div className="space-y-4">
            <label className="flex items-center justify-between gap-4 cursor-pointer">
              ...
              >
                <div className={`w-4 h-4 bg-white dark:bg-[#12151C] rounded-full shadow transition-transform ${settings.autoRemindersEnabled ? 'translate-x-6' : 'translate-x-0'}`} />
              </div>
            </label>
            {settings.autoRemindersEnabled && (
              <div>
                ...
                <input
                  ...
                  min={1}
                  max={7}
                  className="w-24 px-4 py-2.5 text-sm border border-gray-200 dark:border-white/10 dark:border-[#2D2D2D] rounded-lg bg-transparent text-gray-900 dark:text-white focus:outline-none focus:border-[#BF0A30]"
