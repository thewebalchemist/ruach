  ...
  async function redirectByRole(userId: string) {
    ...
    if (tab === 'teacher') {
      if (!['teacher', 'admin', 'pastor', 'leader'].includes(role)) {
        setError('You do not have facilitator access.'); await supabase.auth.signOut(); setLoading(false); return;
      }
    ...
    if (!profile?.member_id) {
      setError('You must have graduated from Connect Class to access Discipleship. Please use the Connect portal.');
