    ...
    <Layout title="Connect" description="Connect to your purpose at Ruach Tabernacle. Our journey begins with Connect Class, grows through Discipleship, and culminates in Service.">
      ...
      <section className="relative min-h-[65vh] flex items-end bg-[#0A0C10] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 pb-20 pt-32 w-full">
          <h1 className="text-6xl md:text-7xl text-white leading-tight mb-2" style={heading}>Connect to<br />Your Purpose</h1>
        </div>
      </section>
      ...
      <section className="bg-white py-16 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-3xl md:text-4xl text-[#111827]" style={heading}>A place for you and your family</h2>
            <Link href="/r-communities" className="border-2 border-[#111827] text-[#111827] hover:bg-[#111827] hover:text-white font-bold text-xs uppercase tracking-widest px-5 py-3 rounded-lg transition-all" style={heading}>Check More →</Link>
          </div>
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              { name: "What about the kids?", sub: 'R-Kids Church', href: '/r-kids-church', img: '/kids/children-1.jpeg', cta: 'Check R-Kids' },
              { name: "What about the teens?", sub: 'Trendsetters', href: '/rt-teens-church', img: '/church-photos/IMG_2279.jpeg', cta: 'Check Trendsetters' },
              { name: "What about the young adults?", sub: 'Bridge Youth', href: '/rt-youth-church', img: '/church-photos/june-2025.jpg', cta: 'Check Bridge' },
            ].map((c) => (
