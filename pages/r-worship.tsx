...
export default function RWorshipPage() {
  return (
    <Layout title="R-Worship — Ruach Tabernacle" description="R-Worship leads the congregation of Ruach Tabernacle into God's presence through music, song, and Spirit-led worship.">
      ...
      <section className="relative min-h-[70vh] flex items-end bg-black overflow-hidden">
        <div className="absolute inset-0">
          ...
          <img src="/church-photos/worship1.jpg" alt="R-Worship" className="absolute inset-0 w-full h-full object-cover opacity-45"
            onError={(e) => { (e.target as HTMLImageElement).src = '/church-photos/ruach1.jpg'; }} />
          <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent" />
        </div>
        <div className="spirit-orb spirit-breathe absolute w-[600px] h-[600px] bg-[#BF0A30]"
          style={{ top: '0%', right: '10%', filter: 'blur(140px)', opacity: 0.14, ['--spirit-dur' as string]: '10s' }} />
        <div className="relative max-w-7xl mx-auto px-8 lg:px-16 pb-20 pt-32 w-full">
          <p className="text-[#BF0A30] text-xs font-bold uppercase tracking-widest mb-4" style={H}>Ministry</p>
          <h1 className="text-5xl md:text-7xl text-white leading-tight mb-4" style={H}>R-Worship</h1>
        ...
        <div className="max-w-7xl mx-auto px-8 lg:px-16">
          <div className="max-w-2xl">
            ...
            <p className="text-[#374151] leading-relaxed mb-4">
              R-Worship is the heartbeat of Ruach Tabernacle — a team of Spirit-filled worshippers committed to ushering the congregation into the manifest presence of God every single service.
            </p>
            <p className="text-[#374151] leading-relaxed mb-8">
              We believe worship is more than music — it is a lifestyle of surrender, and we are committed to leading from that place.
            </p>
